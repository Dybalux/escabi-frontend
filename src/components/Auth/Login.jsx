...
export default function Login() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#0D4F4F] to-[#0A3636] px-4">
            <Helmet>
                <title>Iniciar Sesión | Alto Trago</title>
                <meta name="description" content="Ingresá a tu cuenta de Alto Trago para realizar pedidos y ver tus compras anteriores." />
                <link rel="canonical" href="https://altotrago.com/login" />
            </Helmet>
