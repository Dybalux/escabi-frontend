...
import { LayoutDashboard, Package, ShoppingBag, Users, Settings, Truck, PackageOpen, Percent, Monitor } from 'lucide-react';
...
export default function AdminNav() {
    ...
    const navItems = [
        ...
        { path: '/admin/combos', icon: PackageOpen, label: 'Combos' },
        ...
        { path: '/admin/system-settings', icon: Monitor, label: 'Sistema' },
    ];
